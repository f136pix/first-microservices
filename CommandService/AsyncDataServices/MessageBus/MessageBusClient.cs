...
public class MessageBusClient : IMessageBusClient
{
    ...
    public MessageBusClient(IConfiguration configuration)
    {
        ...
        try
        {
            ...
            _channel.QueueDeclare(queue: "asyncBusLog", durable: true, exclusive: false, autoDelete: false);
    ...
    public void PublishNewPlatform(PlatformPublishDto platformPublishDto)
    {
        ...
        Console.WriteLine("--> RabbitMq connection OK, sending message to PHP service");
        SendMessage(message);
    }

    public void PublishNewCommand(CommandPublishDto commandPublishDto)
    {
        var message = JsonSerializer.Serialize(commandPublishDto);
